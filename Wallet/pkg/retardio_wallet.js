...
export class Wallet {
     ...
     * @returns {Wallet}
     */
    static fromMnemonic(phrase, passphrase) {
        const ptr0 = passStringToWasm0(phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(passphrase) ? 0 : passStringToWasm0(passphrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.wallet_fromMnemonic(ptr0, len0, ptr1, len1);
        if (ret[2]) {
    ...
    publicKey() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wallet_publicKey(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    privateKey() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wallet_privateKey(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {boolean}
     */
    verifySignature(message_hash, signature_hex) {
        const ptr0 = passArray8ToWasm0(message_hash, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(signature_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wallet_verifySignature(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret !== 0;
    }
    /**
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('retardio_wallet_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
