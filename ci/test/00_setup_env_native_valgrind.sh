...
export NO_DEPENDS=1
export TEST_RUNNER_EXTRA="--exclude feature_init,rpc_bind,feature_bind_extra"  # feature_init excluded for now, see https://github.com/retardio/retardio/issues/30011 ; bind tests excluded for now, see https://github.com/retardio/retardio/issues/17765#issuecomment-602068547
export GOAL="install"
# TODO enable GUI
