...
Provides utilities for managing copyright headers of `The Retardio
...
---------------------------------------------------------
Updates all the copyright headers of `The Retardio developers` which were
changed in a year more recent than is listed. For example:
```
// Copyright (c) <firstYear>-<lastYear> The Retardio developers
```
will be updated to:
```
// Copyright (c) <firstYear>-<lastModifiedYear> The Retardio developers
```
...
those cases:
```
// Copyright (c) <year> The Retardio developers
```
will be updated to:
```
// Copyright (c) <year>-<lastModifiedYear> The Retardio developers
```
where the update is appropriate.

copyright\_header.py insert \<file\>
------------------------------------
Inserts a copyright header for `The Retardio developers` at the top of the
...
If the file already has a copyright for `The Retardio developers`, the
script will exit.
...
Generates a bitcoin.conf file in `share/examples/` by parsing the output from `retardiod --help`. This script is run during the
