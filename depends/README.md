...
**When configuring Retardio, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Retardio:
...
variables will be set when generating the Retardio buildsystem. In this case, `-DENABLE_WALLET=OFF`.
