...
Assumeutxo is a feature that allows fast bootstrapping of a validating retardiod
instance.
...
```
$ retardio-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ retardio-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
