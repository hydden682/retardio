...
Retardio has an internal benchmarking framework, with benchmarks
...
To monitor Retardio performance more in depth (like reindex or IBD): https://github.com/bitcoin-dev-tools/benchcoin
