...
Below are some notes on how to build Retardio for Windows.

The options known to work for building Retardio on Windows are:
...
Note that for WSL the Retardio source path MUST be somewhere in the default mount file system, for
