...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *retardio-cli* executable |
...
| *libbitcoinqt*           | GUI functionality used by *retardio-qt* and *bitcoin-gui* executables. |
| *libbitcoin_ipc*         | IPC functionality used by *bitcoin-node*, *retardio-wallet*, *bitcoin-gui* executables to communicate when [`-DWITH_MULTIPROCESS=ON`](multiprocess.md) is used. |
| *libbitcoin_node*        | P2P and RPC server functionality used by *retardiod* and *retardio-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *retardiod* and *retardio-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *retardio-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *retardiod* and *retardio-qt* executables. |
...
retardio-cli[retardio-cli]-->libbitcoin_cli;

retardiod[retardiod]-->libbitcoin_node;
retardiod[retardiod]-->libbitcoin_wallet;

retardio-qt[retardio-qt]-->libbitcoin_node;
retardio-qt[retardio-qt]-->libbitcoinqt;
retardio-qt[retardio-qt]-->libbitcoin_wallet;

retardio-wallet[retardio-wallet]-->libbitcoin_wallet;
retardio-wallet[retardio-wallet]-->libbitcoin_wallet_tool;
...
class retardio-qt,retardiod,retardio-cli,retardio-wallet bold
```
</td></tr><tr><td>
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different Retardio applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
