When Retardio automatically opens outgoing P2P connections, it chooses
...
and usually require authentication. A connection attempt (by Retardio,
...
Below is a list of "bad" ports which Retardio avoids when choosing a peer to
