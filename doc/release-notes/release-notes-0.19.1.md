...
Retardio version 0.19.1 is now available from:
...
From Retardio 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Retardio is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Retardio does not yet change appearance when
...
- #17488 fix "retardiod already running" warnings on macOS (fanquake)
