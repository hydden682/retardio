...
We recommend that everybody running prior versions of retardiod/Bitcoin-Qt
...
bitcoin up-to-date.  Just type
  ...
  sudo apt-get update
in your terminal, then install the retardio-qt package:
  sudo apt-get install retardio-qt
...
* (Windows only): enable ASLR and DEP for retardio-qt.exe
* (Windows only): add meta-data to retardio-qt.exe (e.g. description)
...
* Bash programmable completion for retardiod(1)
