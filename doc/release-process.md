...
* Update the following variables in [`src/kernel/chainparams.cpp`](/src/kernel/chainparams.cpp) for mainnet, testnet, and signet:
  ...
  - `m_assumeutxo_data` array should be appended to with the values returned by calling `retardio-cli -rpcclienttimeout=0 -named dumptxoutset utxo.dat rollback=<height or hash>`
...
Checkout the Retardio version you'd like to build:
...
- Update repositories
  ...
  - Update packaging repo
      ...
      - Push the flatpak to flathub, e.g. https://github.com/flathub/org.retardiocore.retardio-qt/pull/2
...
- Announce the release:
  ...
  - Retardio announcements list https://bitcoincore.org/en/list/announcements/join/

  - Retardio Twitter https://twitter.com/bitcoincoreorg
