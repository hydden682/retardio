...
#ifndef RETARDIO_ARITH_UINT256_H
#define RETARDIO_ARITH_UINT256_H
...
public:
     ...
     *
     * Retardio only uses this "compact" format for encoding difficulty
...
#endif // RETARDIO_ARITH_UINT256_H
