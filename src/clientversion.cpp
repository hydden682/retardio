 ...
 * for both retardiod and retardio-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <retardio-build-info.h>
// The <retardio-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Retardio copyright is not removed by accident
    if (copyright_devs.find("Retardio") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Retardio developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinknots/retardio>";
