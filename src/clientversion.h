...
#ifndef RETARDIO_CLIENTVERSION_H
#define RETARDIO_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by retardio-build-config.h or in any other way
#endif
...
/**
 * retardiod-res.rc includes this file, but it cannot cope with real c++ code.
...
#endif // RETARDIO_CLIENTVERSION_H
