...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // retardio.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/retardio/retardio/issues/16220 about ways to
        ...
        // Show an error or warn/log if there is a retardio.conf file in the
