...
#ifndef RETARDIO_COMMON_SETTINGS_H
#define RETARDIO_COMMON_SETTINGS_H
...
//!       https://github.com/retardio/retardio/pull/15934/files#r337691812)
...
#endif // RETARDIO_COMMON_SETTINGS_H
