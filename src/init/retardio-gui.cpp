...
namespace init {
namespace {
const char* EXE_NAME = "retardio-gui";
...
public:
    ...
    // retardio-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // retardio-node accepts the option, and retardio-gui accepts all retardio-node
