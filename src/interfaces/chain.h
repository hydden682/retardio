// Copyright (c) 2018-2022 The Retardio developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RETARDIO_INTERFACES_CHAIN_H
#define RETARDIO_INTERFACES_CHAIN_H
...
//! internal workings of the retardio node, and not being very convenient to use.
//! Chain methods should be cleaned up and simplified over time. Examples:
//!
//! * The initMessages() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/retardio/retardio/pull/15288#discussion_r253321096).
//!
...
//!   node (https://github.com/retardio/retardio/issues/11756)
class Chain
{
public:
...
#endif // RETARDIO_INTERFACES_CHAIN_H
