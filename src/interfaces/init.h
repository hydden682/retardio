...
#ifndef RETARDIO_INTERFACES_INIT_H
#define RETARDIO_INTERFACES_INIT_H
...
//! (retardio-gui, retardio-node, retardio-wallet, retardiod, retardio-qt) and each
...
#endif // RETARDIO_INTERFACES_INIT_H
