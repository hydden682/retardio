...
#ifndef RETARDIO_INTERFACES_NODE_H
#define RETARDIO_INTERFACES_NODE_H
...
//! Top-level interface for a retardio node (retardiod process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or retardio.conf.
...
#endif // RETARDIO_INTERFACES_NODE_H
