// Copyright (c) 2023 The Retardio developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RETARDIO_IPC_CAPNP_COMMON_TYPES_H
#define RETARDIO_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between retardio processes.
...
//! Functions to serialize / deserialize common retardio types.
namespace mp {
...
#endif // RETARDIO_IPC_CAPNP_COMMON_TYPES_H
