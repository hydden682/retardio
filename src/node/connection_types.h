...
#ifndef RETARDIO_NODE_CONNECTION_TYPES_H
#define RETARDIO_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/retardio-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Retardio’s Peer-to-Peer Network")
...
#endif // RETARDIO_NODE_CONNECTION_TYPES_H
