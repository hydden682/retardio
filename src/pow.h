...
/** DigiShield V3 difficulty adjustment - per-block retargeting */
unsigned int CalculateNextWorkRequired_DigiShield(const CBlockIndex* pindexLast, int64_t nAverageTime, const Consensus::Params&);
