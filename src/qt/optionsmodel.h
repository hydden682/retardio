...
#ifndef RETARDIO_QT_OPTIONSMODEL_H
#define RETARDIO_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Retardio client.
...
#endif // RETARDIO_QT_OPTIONSMODEL_H
