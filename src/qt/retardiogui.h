...
#ifndef RETARDIO_QT_BITCOINGUI_H
#define RETARDIO_QT_BITCOINGUI_H
...
/**
  Retardio GUI main class. This class represents the main window of the Retardio UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a retardio wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Retardio Transaction from file or clipboard */
...
#endif // RETARDIO_QT_BITCOINGUI_H
