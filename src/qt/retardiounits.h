...
#ifndef RETARDIO_QT_BITCOINUNITS_H
#define RETARDIO_QT_BITCOINUNITS_H
...
/** Retardio unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** Retardio units.
      @note Source: https://en.retardio.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BTC,
        mBTC,
...
#endif // RETARDIO_QT_BITCOINUNITS_H
