...
{
    // Test regression https://github.com/retardio/retardio/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/retardio-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/retardio-core/gui/pull/568.
    // With fListen=false in ~/.config/Retardio/Retardio-Qt.conf and all else left as default,
    // retardio-qt should set both -listen and -listenonion to false and start successfully.
