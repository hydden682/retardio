...
#ifndef RETARDIO_RPC_PROTOCOL_H
#define RETARDIO_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in retardiod
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Retardio is not connected
