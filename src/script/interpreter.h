...
#ifndef RETARDIO_SCRIPT_INTERPRETER_H
#define RETARDIO_SCRIPT_INTERPRETER_H
...
struct PrecomputedTransactionData
{
    ...
    // These are single-SHA256, see https://github.com/retardio/bips/blob/master/bip-0341.mediawiki#cite_note-16.
...
#endif // RETARDIO_SCRIPT_INTERPRETER_H
