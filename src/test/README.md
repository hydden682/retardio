...
unit testing framework, and since Retardio already uses Boost, it makes
...
during the generation of the Retardio build system
...
To run the GUI unit tests manually, launch `build/bin/test_retardio-qt`
...
`retardiod`. Use `--` to separate these sets of arguments:
...
This data directory looks like a simplified form of the standard `retardiod` data
