...
void IpcSocketTest(const fs::path& datadir)
{
    ...
    //   Address 'unix' path '"/tmp/test_common_Retardio/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff/test_bitcoin.sock"' exceeded maximum socket path length
