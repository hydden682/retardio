// Copyright (c) 2012-2022 The Retardio developers
...
{
    BOOST_CHECK(TestSplitHost("www.retardiocore.org", "www.retardiocore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.retardiocore.org]", "www.retardiocore.org", 0));
    BOOST_CHECK(TestSplitHost("www.retardiocore.org:80", "www.retardiocore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.retardiocore.org]:80", "www.retardiocore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.retardiocore.org:65536", "www.retardiocore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.retardiocore.org:0", "www.retardiocore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.retardiocore.org:", "www.retardiocore.org:", 0, false));
}
