...
#ifndef RETARDIO_TEST_SCRIPTNUM10_H
#define RETARDIO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Retardio 0.10.0, for cross-comparison.
 */
public:
...
#endif // RETARDIO_TEST_SCRIPTNUM10_H
