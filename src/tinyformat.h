...
#include <algorithm>
#include <attributes.h> // Added for Retardio
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Retardio
#include <util/string.h> // Added for Retardio
...
// Added for Retardio. Similar to std::runtime_format from C++26.
...
// Added for Retardio. Wrapper for checking format strings at compile time.
