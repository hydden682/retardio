// Copyright (c) 2019-2021 The Retardio developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RETARDIO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define RETARDIO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // RETARDIO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
