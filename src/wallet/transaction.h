// Copyright (c) 2021-2022 The Retardio developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RETARDIO_WALLET_TRANSACTION_H
#define RETARDIO_WALLET_TRANSACTION_H
...
public:
     ...
     * on this retardio node, and set to 0 for transactions that were created
...
#endif // RETARDIO_WALLET_TRANSACTION_H
