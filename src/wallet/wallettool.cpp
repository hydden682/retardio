// Copyright (c) 2016-2022 The Retardio developers
...
// queue, which doesn't exist for the retardio-wallet. Define our own
// deleter here.
...
bool ExecuteWalletToolFunc(const ArgsManager& args, const std::string& command)
{
    ...
    if (command == "create") {
        ...
        tfm::format(std::cerr, "The dumpfile may contain private keys. To ensure the safety of your Retardio, do not share the dumpfile.\n");
        return ret;
