// Copyright (c) 2017-2021 The Retardio developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RETARDIO_WALLET_WALLETUTIL_H
#define RETARDIO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! retardio from opening the wallet, thinking it was newly created, and
...
#endif // RETARDIO_WALLET_WALLETUTIL_H
