// Copyright (c) 2015-present The Retardio developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RETARDIO_ZMQ_ZMQNOTIFICATIONINTERFACE_H
#define RETARDIO_ZMQ_ZMQNOTIFICATIONINTERFACE_H
...
#endif // RETARDIO_ZMQ_ZMQNOTIFICATIONINTERFACE_H
